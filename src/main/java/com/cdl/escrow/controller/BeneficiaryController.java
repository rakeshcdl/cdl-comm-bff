...
public class BeneficiaryController {
    ...
    @GetMapping
    public ResponseEntity<Page<BeneficiaryDTO>> getAllBeneficiaryCriteria(@ParameterObject BeneficiaryCriteria criteria,
                                                                                   @ParameterObject Pageable pageable) {
        Page<BeneficiaryDTO> page = beneficiaryCriteriaService.findByCriteria(criteria, pageable);
