...
public class AgreementParametersController {
    ...
    @GetMapping
    public ResponseEntity<Page<AgreementParametersDTO>> getAllAgreementParametersCriteria(@ParameterObject AgreementParametersCriteria criteria,
                                                                                   @ParameterObject Pageable pageable) {
        Page<AgreementParametersDTO> page = agreementParametersCriteriaService.findByCriteria(criteria, pageable);
