...
public class BulkPaymentUploadController {
    ...
    @GetMapping
    public ResponseEntity<Page<BulkPaymentUploadDTO>> getAllBulkPaymentUploadCriteria(@ParameterObject BulkPaymentUploadCriteria criteria,
                                                                                   @ParameterObject Pageable pageable) {
        Page<BulkPaymentUploadDTO> page = bulkPaymentUploadCriteriaService.findByCriteria(criteria, pageable);
