...
public class AuthorizedSignatoryController {
    ...
    @GetMapping
    public ResponseEntity<Page<AuthorizedSignatoryDTO>> getAllAccountPurpose(@ParameterObject AuthorizedSignatoryCriteria criteria,
                                                                                   @ParameterObject Pageable pageable) {
        Page<AuthorizedSignatoryDTO> page = authorizedSignatoryCriteriaService.findByCriteria(criteria, pageable);
