...
public class AgreementTypeController {
   ...
   @GetMapping
    public ResponseEntity<Page<AgreementTypeDTO>> getAllAgreementTypeCriteria(@ParameterObject AgreementTypeCriteria criteria,
                                                                                   @ParameterObject Pageable pageable) {
        Page<AgreementTypeDTO> page = agreementTypeCriteriaService.findByCriteria(criteria, pageable);
