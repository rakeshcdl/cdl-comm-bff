...
public class PaymentInstructionController {
    ...
    @GetMapping
    public ResponseEntity<Page<PaymentInstructionDTO>> getAllPaymentInstructionCriteria(@ParameterObject PaymentInstructionCriteria criteria,
                                                                                   @ParameterObject Pageable pageable) {
        Page<PaymentInstructionDTO> page = paymentInstructionCriteriaService.findByCriteria(criteria, pageable);
