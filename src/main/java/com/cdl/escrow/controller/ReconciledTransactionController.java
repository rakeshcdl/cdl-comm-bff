...
public class ReconciledTransactionController {
    ...
    @GetMapping
    public ResponseEntity<Page<ReconciledTransactionDTO>> getAllReconciledTransactionCriteria(@ParameterObject ReconciledTransactionCriteria criteria,
                                                                                   @ParameterObject Pageable pageable) {
        Page<ReconciledTransactionDTO> page = reconciledTransactionCriteriaService.findByCriteria(criteria, pageable);
