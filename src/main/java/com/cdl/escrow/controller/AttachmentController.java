...
public class AttachmentController {
   ...
   @GetMapping
    public ResponseEntity<Page<AttachmentDTO>> getAllAttachmentCriteria(@ParameterObject AttachmentCriteria criteria,
                                                                                   @ParameterObject Pageable pageable) {
        Page<AttachmentDTO> page = attachmentCriteriaService.findByCriteria(criteria, pageable);
