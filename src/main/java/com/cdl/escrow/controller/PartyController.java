...
public class PartyController {
    ...
    @GetMapping
    public ResponseEntity<Page<PartyDTO>> getAllPartyCriteria(@ParameterObject PartyCriteria criteria,
                                                                                   @ParameterObject Pageable pageable) {
        Page<PartyDTO> page = partyCriteriaService.findByCriteria(criteria, pageable);
