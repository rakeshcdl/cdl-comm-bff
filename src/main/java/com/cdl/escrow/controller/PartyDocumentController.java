...
public class PartyDocumentController {
   ...
   @GetMapping
    public ResponseEntity<Page<PartyDocumentDTO>> getAllPartyDocumentCriteria(@ParameterObject PartyDocumentCriteria criteria,
                                                                                   @ParameterObject Pageable pageable) {
        Page<PartyDocumentDTO> page = partyDocumentCriteriaService.findByCriteria(criteria, pageable);
